    ...
    <div class="q-pa-md">
      <q-card class="q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-8" active-color="black">
          ...
          <q-breadcrumbs-el label="Penarikan" icon="payments" />
        </q-breadcrumbs>
      </q-card>
      <div class="row items-center q-col-gutter-md q-pt-md">
        <div class="col-md-12 col-xs-12">
          ...
          >
            <template v-slot:top>
              <div class="col">
                <div class="text-weight-bold">PENARIKAN</div>
                <div>Daftar semua penarikan pada saat ini</div>
              </div>
        ...
        <q-item>
          ...
          <q-item-section>
            <q-item-label class="text-weight-bold text-uppercase">
              Input /Edit Penarikan
            </q-item-label>
            <q-item-label caption>
              Input atau edit data penarikan
            </q-item-label>
          </q-item-section>
