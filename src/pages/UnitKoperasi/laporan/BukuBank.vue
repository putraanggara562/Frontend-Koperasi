    ...
    <div class="q-pa-md">
      <q-card class="q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-8" active-color="black">
          ...
          <q-breadcrumbs-el label="Laporan Buku Bank" icon="trending_up" />
        </q-breadcrumbs>
      </q-card>
      <div class="row items-center q-col-gutter-md q-pt-md">
        <div class="col-md-12 col-xs-12">
          ...
          >
            <template v-slot:top>
              <div class="col">
                <div class="text-weight-bold">LAPORAN BUKU BANK</div>
                <div>Daftar laporan buku bank pada saat ini</div>
              </div>
