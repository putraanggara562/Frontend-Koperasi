    ...
    <div class="q-pa-md">
      <q-card class="q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-8" active-color="black">
          ...
          <q-breadcrumbs-el label="Laporan Simpanan" icon="business_center" />
        </q-breadcrumbs>
      </q-card>
      <div class="row items-center q-col-gutter-md q-pt-md">
        <div class="col-md-12 col-xs-12">
          ...
          >
            <template v-slot:top>
              <div class="col">
                <div class="text-weight-bold">LAPORAN SIMPANAN</div>
                <div>Daftar laporan simpanan pada saat ini</div>
              </div>
